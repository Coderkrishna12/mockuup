...
export default function MoviesPage() {
    ...
    return (
        <div className="min-h-screen">
            <CinematicHero3D
                characterImg="https://image.tmdb.org/t/p/original/c24sv2weTHPsmDa7jEMN0m2P3RT.jpg"
                titlePrefix="WITNESS THE"
                titleMain="MULTIVERSE SAGA"
                subtitle="From the birth of Iron Man to the collapse of the Multiverse — follow every chapter of the greatest cinematic journey ever told."
                primaryCTAText="Browse Movies"
                primaryCTALink="#movies"
                secondaryCTAText="View Timeline"
                ...
                anchorId="movies"
                accentColor="#3b82f6" // Spider-Man blue/red theme
                titleGradient="linear-gradient(135deg, #ef4444 0%, #3b82f6 50%, #fbbf24 100%)"
            />

            <div id="movies" className="pt-20 md:pt-24 pb-24">
